...
**Branch:** `main`  
**HEAD:** `2aada22` (`2aada22082c0b8f23231efd711cf39dec1c52206`) · tag **`v0.3.0-alpha.1`**
...
| [#83](https://github.com/scrimshawlife-ctrl/Patch-Hive/pull/83) | Staging host plan + compose.staging; dual-path design F0; alpha release notes |
| tag `v0.3.0-alpha.1` | Hardening alpha on main (not production) |
