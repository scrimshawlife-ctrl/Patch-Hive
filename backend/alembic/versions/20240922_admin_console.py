...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_admin_audit_log_actor_user_id", "admin_audit_log", ["actor_user_id"], unique=False
    )
    ...
    op.create_index(
        "ix_gallery_revisions_module_key", "gallery_revisions", ["module_key"], unique=False
    )
    op.create_index(
        "ix_gallery_revisions_revision_id", "gallery_revisions", ["revision_id"], unique=False
    )
