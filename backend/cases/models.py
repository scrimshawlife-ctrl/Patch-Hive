...
class Case(Base):
    ...
    # C1 format honesty (legacy cases table; catalog uses case_catalog.format_family)
    format_family = Column(String(64), nullable=True, index=True)
    capacity_unit = Column(String(64), nullable=True, index=True)
